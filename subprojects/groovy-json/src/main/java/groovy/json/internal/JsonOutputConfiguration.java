...
/**
 * Internal configuration representation in use by {@link groovy.json.JsonOutput}. Takes a configuration map
 * and parses its content. <tt></tt>JsonOutputConfiguration</tt> has public methods to query configuration settings
 * for JsonOutput.
 *
